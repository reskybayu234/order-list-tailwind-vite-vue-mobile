  ...
  <section class="flex items-center justify-center absolute inset-0">
    ...
    >
      ...
      <div class="px-8 md:px-4">
        <h2
          class="font-bold flex justify-center text-3xl text-[#002D74] body-font font-markazi"
        >
          Login
        </h2>
        <p class="text-md mt-4 text-[#002D74] font-markazi">
          If you are already a member, easly log in
        </p>
        ...
        <div class="relative">
          ...
          <svg
            ...
            height="20"
            fill="gray"
            class="bi bi-eye absolute top-2/3 right-5 -translate-y-1/2"
            viewBox="1 1 14 16"
          >
            <path
        ...
        <div class="mt-3 text-xs flex flex-row items-center text-[#002D74]">
          <p>Don't have an account?</p>
          <button
            class="py-2 px-5 bg-white border ml-2 rounded-xl hover:scale-110 duration-300"
          >
            Register
          </button>
        </div>
